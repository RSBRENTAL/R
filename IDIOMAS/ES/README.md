...
- `05_PROMPT_GITHUB_ES.txt`: prompt operativo vigente.

Fuente empresarial vigente:
- `../../AUDITORIA_COMPARTIDA/DATOS_CANONICOS_PROPIETARIO.md`

El antiguo `05_PROMPT_NUEVO_CHAT_ES.txt` queda retirado para evitar el uso accidental de instrucciones obsoletas.

Totales de la fuente original:
- Páginas: 20
- Incidencias de dimensiones registradas: 38
