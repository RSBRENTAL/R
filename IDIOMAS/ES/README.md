...
- `05_PROMPT_NUEVO_CHAT_ES.txt`: prompt exacto para abrir un chat nuevo y corregir solo este idioma.

Totales:
- Páginas: 20
- Incidencias de dimensiones: 38
- HTML afectados por dimensiones: 18
