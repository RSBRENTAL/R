...
- `05_PROMPT_GITHUB_PL.txt`: prompt operativo vigente.

Fuente empresarial vigente:
- `../../AUDITORIA_COMPARTIDA/DATOS_CANONICOS_PROPIETARIO.md`

El antiguo `05_PROMPT_NUEVO_CHAT_PL.txt` queda retirado para evitar el uso accidental de instrucciones obsoletas.
